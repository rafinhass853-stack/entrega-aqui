...
const GlobalStyles = () => (
  <style>{`
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    /* Evita “corte” por largura maior que a tela */
...
export const Layout = ({ children, isMobile, user }) => {
  ...
  // ✅ Fallback importante: se você esquecer de passar user no <Layout />
  // (isso evita sidebar “quebrar” e também evita consultas erradas)
  ...
  const currentLabel = menuItems.find((item) => item.path === location.pathname)?.label || 'Dashboard';
  ...
  return (
    <>
      ...
      {/* ✅ Conteúdo Principal (CORREÇÃO DO CORTE) */}
      <main
        style={{
          // AQUI estava o problema: width: '100%' + marginLeft = 260px => passa da tela e “corta”.
